...
3. [Interactive Terminal Capabilities](#️-interactive-terminal-capabilities)
...
4. [Architectural Subsystems](#️-architectural-subsystems-newcodecpp)
5. [Build & Run Instructions](#️-build--run-instructions)
...
* ��� **Admin:** Highest clearance. Unrestricted access to all features, infrastructure management, and economy oversight.
* ��� **Police:** Law Enforcement. Authorized to alter traffic flow (blockades) and issue financial citations to users.
* ��� **Driver:** Basic civilian clearance. Authorized to calculate routes, reserve parking, and manage personal vehicles. Emergency Medical Services (EMS) inherit this role with special bypass flags.
* ��� **Analyst:** Engineering and accounting clearance. Permitted to process graph calculations (MST) and view global tolls/revenues.

---

## ���️ Interactive Terminal Capabilities
...
## ���️ Architectural Subsystems (`newcode.cpp`)
